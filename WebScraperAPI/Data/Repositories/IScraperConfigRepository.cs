...
namespace WebScraperAPI.Data.Repositories
{
    ...
    public interface IScraperConfigRepository
    {
        ...
        Task<IEnumerable<ScraperConfig>> GetAllAsync();
        ...
        Task<ScraperConfig> GetByIdAsync(Guid id);
        ...
        Task<ScraperConfig> CreateAsync(ScraperConfig config);
        ...
        Task<bool> UpdateAsync(ScraperConfig config);
        ...
        Task<IEnumerable<ScraperLog>> GetLogsAsync(Guid scraperId, int limit = 100);
        ...
        Task AddLogAsync(ScraperLog log);
        ...
        Task<IEnumerable<ScraperRun>> GetRunsAsync(Guid scraperId, int limit = 10);
        ...
        Task<ScraperRun> AddRunAsync(ScraperRun run);
        ...
        /// <returns>True if the update was successful, false otherwise</returns>
        Task<bool> UpdateRunAsync(ScraperRun run);
    }
}
