...
namespace WebScraperAPI.Data.Repositories
{
    ...
    public interface IScrapedContentRepository
    {
        ...
        Task<ScrapedContent> GetByUrlAsync(string url);
        ...
        /// <returns>The scraped content if found, or null</returns>
        Task<ScrapedContent> GetByIdAsync(string id);
        ...
        Task<(IEnumerable<ScrapedContent> Items, int TotalCount)> GetByScraperIdAsync(
        ...
        Task<ScrapedContent> SaveContentAsync(ScrapedContent content);
        ...
        Task<ContentVersion> AddVersionAsync(ContentVersion version);
        ...
        Task<IEnumerable<ContentVersion>> GetVersionsAsync(string contentId, int limit = 5);
        ...
        Task<(IEnumerable<ScrapedContent> Items, int TotalCount)> SearchAsync(
        ...
        Task<IEnumerable<ScrapedContent>> GetChangedContentSinceAsync(
