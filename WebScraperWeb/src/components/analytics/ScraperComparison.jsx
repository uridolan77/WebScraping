...
const ScraperComparison = ({ timeframe, fetchScraperComparison }) => {
  const { scrapers, loading: scrapersLoading } = useScrapers();
  ...
  const prepareRadarData = () => {
    ...
    return metrics.map(metric => {
      ...
      comparisonData.metrics.forEach(scraperMetric => {
        dataPoint[scraperMetric.scraperName] = scraperMetric[metric];
      });
