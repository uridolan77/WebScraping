...
const TrendAnalysis = ({ timeframe, fetchTrendAnalysis }) => {
  ...
  const getTrendDescription = (trend, metricType) => {
  ...
  const trend = trendData ? calculateTrend(trendData.data) : { value: 0, direction: 'flat' };
