...
export const getScraperScheduledTasks = async (scraperId) => {
  try {
...
export const pauseScheduledTask = async (id) => {
  try {
...
export const resumeScheduledTask = async (id) => {
  try {
...
export const getTaskExecutionHistory = async (id, limit = 10) => {
  try {
